  ...
  return (
    <div className="mx-auto max-w-lg px-6 py-16 text-center space-y-4">
      ...
      <div className="pt-4 flex items-center justify-center gap-3">
        <Link
          to="/login"
          className="inline-flex items-center justify-center rounded-md border border-surface-600 px-4 py-2 text-sm font-medium text-gray-100 hover:bg-surface-800 transition-colors"
        >
          Sign in
        </Link>
        <Link
