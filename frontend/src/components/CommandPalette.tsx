...
export const MODULE_ROUTES_ALL: Array<{ to: string; label: string; module: ModuleId; keywords: string; tenantQuery?: boolean }> = [
  ...
  { to: "/rules/visual", label: "Legacy canvas (not a product SKU)", module: "rules", keywords: "visual builder graph canvas dsl legacy" },
  { to: "/ops/shadow", label: "Sentence pack", module: "rules", keywords: "sentence pack observe no-code json" },
