...
from orchestrator.shadow_graph_payload import build_shadow_analyze_payload  # noqa: E402
...
def test_build_shadow_analyze_payload_janus_injects_graph_topology() -> None:
    from orchestrator.graph.client import JanusGraphClient  # noqa: PLC0415
