...
def build_forensic_taxonomy_system_prompt(
    *,
    ...
    from shadow_agent.main import build_evaluate_retroactive_system_prompt  # noqa: PLC0415
...
async def evaluate_retroactive(
    ...
    *,
    ...
    from shadow_agent.main import evaluate_retroactive as _evaluate_retroactive  # noqa: PLC0415
