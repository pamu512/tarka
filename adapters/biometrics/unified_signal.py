...
BiometricTarkaRiskSignal = Annotated[
    FingerprintTarkaRiskSignal | IncogniaTarkaRiskSignal,
...
def parse_biometric_tarka_signal(
    data: object,
) -> FingerprintTarkaRiskSignal | IncogniaTarkaRiskSignal:
...
def dump_biometric_tarka_signal(
    signal: FingerprintTarkaRiskSignal | IncogniaTarkaRiskSignal,
) -> dict:
