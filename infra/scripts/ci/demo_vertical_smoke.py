...
def main() -> int:
    ...
    p.add_argument(
        ...
        help="x-api-key when services use non-empty API_KEYS (see infra/deploy/docker-compose.demo-vertical.yml).",
    )
    ...
    if st in (401, 403):
        ...
        if st_l != 200:
            print(
                ...
                f"(see infra/deploy/docker-compose.demo-vertical.yml) for full vertical.",
                file=sys.stderr,
            )
            return 1
