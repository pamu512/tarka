...
```bash
docker compose -f infra/deploy/janusgraph-cassandra-demo/docker-compose.yml up -d
```
...
```bash
chmod +x infra/deploy/janusgraph-cassandra-demo/scripts/verify-combined-memory-under-5g.sh
./infra/deploy/janusgraph-cassandra-demo/scripts/verify-combined-memory-under-5g.sh
```
...
```bash
docker compose -f infra/deploy/janusgraph-cassandra-demo/docker-compose.yml down -v
```
