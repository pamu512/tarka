...
- :material-kubernetes: **[Deployment Guide](guides/deployment.md)**
    ...
    Deploy to production with Docker Compose profiles or Helm on Kubernetes. **[OSS track closure checklist](guides/oss-track-issue-closure-evidence-2026-04.md)** (#31–#54 merge evidence). **[v1.2.5 resiliency / ETL / rules backlog](guides/v1.2.5-execution-backlog-resiliency-etl-rules.md)**. **[ETL Bronze/Silver/Gold mapping](guides/etl-bronze-silver-gold.md)**. **[Late arrival & watermarks](guides/late-arrival-watermarks.md)** (Epic E3).
