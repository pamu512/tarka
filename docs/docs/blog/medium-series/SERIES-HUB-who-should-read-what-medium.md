<!--
MEDIUM PUBLISHING (optional: publish as a short “start here” story, or keep repo-only and pin a LinkedIn comment)
Title:    Tarka on Medium: Who Should Read What
Subtitle: A map of the series for operators, engineers, executives, and partners—pick two articles, not all eight.
-->

## Start here (by role)

You do **not** need to read everything. Use this map, then subscribe on Medium [@tarka](https://medium.com/@tarka) for weekly drops.

| If you are… | Read first | Then (optional) |
|-------------|------------|-----------------|
...
Paths are **repo-relative** above; on Medium, replace with your live story URLs as you publish.

## Suggested order (linear binge)

1. Flagship narrative → **feature story**  
2. Ideas without code → **risk/01**, **risk/02**  
3. Vendor metrics + diligence → **risk/04**  
...
Evaluate flow (SDK → Decision API → decision + `inference_context` + tags):  
`docs/docs/assets/tarka-evaluate-architecture.svg` (export to PNG for Medium if needed).

## Repo

[Tarka on GitHub](https://github.com/pamu512/tarka)
