...
|------|-------|-----------------|----------------------|
| Q1-E01 Policy-as-code | [#127](https://github.com/pamu512/tarka/issues/127) | **Slip** to post–v1.2.0 | OPA under `deploy/opa/`; no required `policy-check` PR gate |
...
| Q1-E07 Env parity | [#133](https://github.com/pamu512/tarka/issues/133) | **In progress** | [`packages/tarka-deploy-settings`](../../../packages/tarka-deploy-settings) on `master` |
