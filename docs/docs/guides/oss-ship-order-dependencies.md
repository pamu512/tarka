...
- CI gates: `infra/scripts/policy/validate_typology_definitions.py` (**#34** member rules must exist in packs), `scripts/ml/validate_ml_promotion_policy.py` (**#37/#52** metadata for active models).
