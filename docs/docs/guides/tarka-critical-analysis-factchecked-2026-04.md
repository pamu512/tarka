...
| AWS Lambda is the stateless decision execution substrate.                                      | **Unsupported / inaccurate**                            | Service runtime under `services/`* + deploy manifests under `infra/deploy/`                                                                                              | Implemented runtime is containerized microservices; no Lambda decision execution path is present.                                     |
