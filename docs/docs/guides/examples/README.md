...
| [Vertical pack benchmarks (Day 60)](../../releases/evidence/v1.2.0-vertical-benchmark-scorecard.example.json) | Fixed **`seed: 42`**, `fintech` / `ecommerce` / `gaming` smoke + [thresholds](../../../../scripts/benchmarks/vertical_benchmark_thresholds.v1.json) | **core** (Decision API up) |
