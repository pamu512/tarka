...
**Repo reality (2026-01):** **`packages/fraud-sdk-typescript`** (web) and **`packages/fraud-sdk-python`** (server) ship; **native Android/iOS packages** are **roadmap** (see [`sdk-mobile-project.md`](./sdk-mobile-project.md)), not present as shippable artifacts in-tree.
