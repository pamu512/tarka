...
**Typology DSL (OSS #46):** `typology_definitions_v1.json` + `typology_predicate_registry_v1.json`; `GET /v1/admin/typology/predicate-registry`; CI `infra/scripts/policy/validate_typology_dsl.py`. [Service doc — Typology predicate registry](../services/decision-api.md#typology-predicate-registry-oss-46) · [API Reference](../api-reference.md#decision-api).
