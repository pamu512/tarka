"""Collaboration bridge API for Slack, Teams, and Lark copilot workflows."""
...
from investigation_agent.chat_bridge.agent_client import (
    AgentChatError,
    AgentUpstreamError,
...
from investigation_agent.chat_bridge.rate_limit import MinuteRateLimiter
...
if not _CHAT_BRIDGE_SUBAPP:
    setup_observability(app, "collaboration-chat-bridge")
...
async def health():
    return {
        ...
        "investigation_agent_configured": bool((settings.investigation_agent_url or "").strip()),
        "investigation_agent_inproc": not bool((settings.investigation_agent_url or "").strip()),
