# {{ cookiecutter.customer_display_name }} — investigation integration adapter
...
- `src/{{ cookiecutter.package_name }}/adapter.py` — map customer APIs ↔ investigation-agent tool payloads (replace stubs).
- `tests/` — extend with contract tests against customer sandboxes or recorded fixtures.

## References (Tarka OSS reference)
...
- [Customer API change policy](https://github.com/tarka-ai/fraud-stack/blob/main/docs/docs/guides/investigation-agent-integration-contract.md)
