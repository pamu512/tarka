...
use crate::error::{json_parse_err, json_serialize_err, TarkaEngineError};
...
use crate::logging_bridge;
use crate::pack_json_ast as json_ast;
...
#[pyfunction]
pub(crate) fn sync_packs_json(packs_json: String) -> PyResult<()> {
...
#[pyfunction]
pub(crate) fn rust_engine_cache_stats() -> PyResult<(usize, bool)> {
...
#[pyfunction]
pub(crate) fn evaluate_json_rules_rust(
...
#[pyfunction]
pub(crate) fn evaluate_adhoc_packs_rust(
    packs_json: String,
    features_json: String,
    redis_tags_json: String,
    tenant_id: String,
...
#[pyfunction]
pub(crate) fn validate_json_rule_ast(ast_json: String) -> PyResult<()> {
...
#[pyfunction]
pub(crate) fn evaluate_json_ast_strict(ast_json: String, features_json: String) -> PyResult<bool> {
    let v: Value = serde_json::from_str(&ast_json)
...
pub(crate) fn register_pack_ffi(m: &Bound<'_, PyModule>) -> PyResult<()> {
    m.add(
        "JsonAstMalformedError",
