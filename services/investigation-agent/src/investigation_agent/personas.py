...
_WORKFLOW_AND_TAIL = (
    ...
    "- Graph nodes may include scored, risk_score, relation_growth_1h/24h, and risk_factors "
    "from graph-service. Cite fast_growth_* / high_degree_vs_peers only when present. "
    "You may pass depth up to 5; default stays 2. Do not fetch a 5-hop subgraph on every turn.\n"
