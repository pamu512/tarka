...
async def run_evaluate_decision(
    ...
    async with acquire_eval_capacity(request.app) as cap:
        ...
        graph_hop_v1 = hop_view_from_graph_meta(
        ...
        if body.device_context is not None:
            ...
            raw_snapshot["integrity"] = integrity_presence(
                body.device_context.signals
                if isinstance(body.device_context.signals, dict)
                else None
            )
        else:
            raw_snapshot["integrity"] = integrity_presence(None)
        if body.agent_context is not None:
        ...
        snap_extra["graph_hop_v1"] = graph_hop_v1
        ...
        schedule_decision_outcomes(
            ...
            flag_mints_leftover=settings.flag_mints_leftover,
