...
class BiometricProfile:
    ...
    def from_signals(
        ...
        return cls(
            ...
            time_to_first_interaction_ms=float(session.get("time_to_first_interaction_ms", -1)),
...
class DeviceIntelligenceStore:
    ...
    async def record_device_ip_velocity(
        ...
        await self._client.expire(f"{DEVICE_IP_VELOCITY_PREFIX}{device_id}:ips", IP_VELOCITY_TTL)
