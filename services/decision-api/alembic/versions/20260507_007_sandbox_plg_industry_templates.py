...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("bundle_key", sa.String(length=64), nullable=False, server_default="plg_industry_v1"),
        ...
        sa.UniqueConstraint("template_key", "bundle_key", name="uq_sandbox_industry_templates_key_bundle"),
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_sandbox_industry_rule_templates_bundle_key"), table_name="sandbox_industry_rule_templates")
