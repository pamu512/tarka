...
**Automated gate** — requires a live Gremlin endpoint, ``gremlinpython``, and JanusGraph configured like ingest::
    ...
    pytest services/orchestrator/tests/test_graph_fraud_backlink_gate.py -q
...
def test_resolve_fraud_sets_janus_user_is_fraud() -> None:
    ...
    from graph.client import JanusGraphClient  # noqa: E402
    from main import create_app  # noqa: E402
    from models.cases import CaseORM, CaseStatus  # noqa: E402
    from workers.graph_sync import read_janus_user_is_fraud_values  # noqa: E402
