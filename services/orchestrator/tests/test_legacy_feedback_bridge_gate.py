...
def test_legacy_ai_feedback_bridges_to_operational_signals(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from models.operational_signals import OperationalSignalORM  # noqa: E402
...
def test_legacy_ai_feedback_transform_unit() -> None:
    from openapi_schemas import AiFeedbackRequest
    from routes.legacy_feedback_bridge import ai_feedback_to_operational_signal
