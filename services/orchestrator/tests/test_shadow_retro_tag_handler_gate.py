...
def test_shadow_retro_tag_handler_queries_clickhouse_and_persists_label() -> None:
    async def _run() -> None:
        ...
        from models.normalized_labels import NormalizedLabelORM, SOURCE_TYPE_CHARGEBACK
        from models.operational_signals import OperationalSignalORM
        from models.outbox import OUTBOX_EVENT_SHADOW_RETRO_TAG, OutboxDAO, OutboxORM
