...
class SignalType(str, Enum):
    ...
    HIL_CONTEXT_OVERRIDE = "HIL_CONTEXT_OVERRIDE"


class HilContextOverrideMetadata(BaseModel):
    """Structured payload for ``HIL_CONTEXT_OVERRIDE`` operational signals."""
    ...
    @field_validator("override_type", "scope_key", "analyst_rationale")
    @classmethod
...
_METADATA_BY_SIGNAL: dict[SignalType, type[BaseModel]] = {
    ...
    SignalType.HIL_CONTEXT_OVERRIDE: HilContextOverrideMetadata,
}
