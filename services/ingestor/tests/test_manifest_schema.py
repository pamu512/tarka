...
import pytest
from manifest_row import ManifestDecodeError, decode_manifest_row, parse_evidence_manifest
...
def test_startup_pin_mismatch_raises() -> None:
    from manifest_schema import assert_ingestor_descriptor_matches_pin
