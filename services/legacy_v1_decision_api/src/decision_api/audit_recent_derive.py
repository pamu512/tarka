...
def derive_rule_result(decision: str, tags: list[Any] | None, snap: dict[str, Any]) -> str:
    ...
    if any("shadow_review" in t or t in {"shadow:review", "shadow_review"} for t in tags_l):
