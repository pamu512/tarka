...
def test_handle_shadow_investigate_payload_invokes_evaluate() -> None:
    ...
    from agent import ShadowAgent  # noqa: E402
    from schemas import ShadowDecision  # noqa: E402
    from workers.shadow_investigate_handler import (
        handle_shadow_investigate_payload,
    )  # noqa: E402
    from workers.runtime import ShadowInvestigateRuntime  # noqa: E402
