...
def export_audit(
    ...
    from tools.audit_export import ExportAuditError, run_export_audit
...
def nuke_cmd(
    ...
    from tools.nuke import NukeError, run_nuke
...
def import_rules_cmd(
    ...
    from rules_import import ImportRulesError, run_import_rules
